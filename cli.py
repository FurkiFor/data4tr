...
Örnek kullanımlar:
  ...
  python cli.py export --format jsonl
    ...
    scrape_parser.add_argument('--source', type=str, default='wikipedia', 
                              help='Veri kaynağı (default: wikipedia)')
    scrape_parser.add_argument('--limit', type=int, default=100,
                              help='Maksimum kayıt sayısı (default: 100)')
    
    # Process komutu
    process_parser = subparsers.add_parser('process', help='Veriyi işle')
    process_parser.add_argument('--model', type=str, default='rule-based',
                               help='AI modeli (default: rule-based)')
    
    # Export komutu
    export_parser = subparsers.add_parser('export', help='Veri setini dışa aktar')
    export_parser.add_argument('--format', type=str, default='jsonl', 
                              choices=['jsonl', 'csv'],
